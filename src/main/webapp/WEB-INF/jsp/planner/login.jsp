                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form name="userLogin" class="user" action="/login.do" method="post">
                                        ...
                                        <a href="javascript:userLogin.submit();" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                    </form>
                                    <hr>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="/insert.do">회원이 아니신가요?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
